...
# The Back-end Microservice 📊
* Implemented with **Java** because of its enterprise-heavy usage, allowing safe code because of static typing and performance
* Follows A RESTful API for managing server resources
* Publishes messages to the **Golang** micro-service when the user requests spread-sheet creation
* Uses Keycloak for identity access and management
